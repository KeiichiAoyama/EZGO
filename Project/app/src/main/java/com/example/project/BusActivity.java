...
public class BusActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFrom = (TextView) findViewById(R.id.btnFromBus);
        calender = (TextView) findViewById(R.id.calender);
        btnTo = (TextView) findViewById(R.id.btnToBus);
        btnPesawat = (MaterialButton) findViewById(R.id.btnSearchBus);
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(BusActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
